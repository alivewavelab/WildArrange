...
| `wildarrange context build [--agent Jiuwei] [--task T001]` | 构建 Agent 上下文 |
...
| `wildarrange prompts variant [--agent Jiuwei] [--provider host|deepseek|gemini|kimi] [--model "..."]` | 查看提示词模型变体 |
